    ...
    <div className="min-h-screen bg-[#0A412B] text-[#F8F3E8]" style={{ fontFamily: "Inter, system-ui, sans-serif" }}>
      <header className="border-b border-[#D4AF37]/30">
        <div className="max-w-5xl mx-auto px-4 py-4 flex items-center justify-between">
          <Link to={`/${lang}`} className="font-bold text-lg text-[#F2D675]">{t.name}</Link>
          <nav className="flex gap-4 text-sm">
            ...
            <a href="https://makne.app" target="_blank" rel="noreferrer" className="hover:text-[#F2D675]">{t.visitMakne}</a>
          </nav>
        </div>
      </header>
